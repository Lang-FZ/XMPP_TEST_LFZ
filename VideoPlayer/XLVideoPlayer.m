...
- (void)videoLow:(UIButton *)btn {
    
    btn.selected = YES;
    
    _videoMid.selected = NO;
    _videoHigh.selected = NO;
    
    AVPlayerItem *item = [[AVPlayerItem alloc] initWithURL:[NSURL URLWithString:[NSString stringWithFormat:@"%@%@%@",VideoUrl,_videoId,VideoUrlLow]]];
    
    [_player replaceCurrentItemWithPlayerItem:item];
}

- (void)videoMid:(UIButton *)btn {
    
    btn.selected = YES;
    
    _videoLow.selected = NO;
    _videoHigh.selected = NO;
    
    AVPlayerItem *item = [[AVPlayerItem alloc] initWithURL:[NSURL URLWithString:[NSString stringWithFormat:@"%@%@%@",VideoUrl,_videoId,VideoUrlMid]]];
    
    [_player replaceCurrentItemWithPlayerItem:item];
}

- (void)videoHigh:(UIButton *)btn {
    ...
    AVPlayerItem *item = [[AVPlayerItem alloc] initWithURL:[NSURL URLWithString:[NSString stringWithFormat:@"%@%@%@",VideoUrl,_videoId,VideoUrlHigh]]];
